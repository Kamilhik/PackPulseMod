...
- automatic Minecraft close when `.jar` mods were updated.
...
After changing mods, configs, resource packs, or shaders, run the same deploy script again.
...
- автоматическое закрытие Minecraft, если обновились `.jar`-моды.
...
После изменения модов, конфигов, ресурспаков или шейдеров просто запусти тот же deploy-скрипт снова.
