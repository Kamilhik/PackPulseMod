...
usage() {
  cat <<EOF
Usage:
  sudo ./scripts/deploy_https_letsencrypt.sh --domain <domain> --email <email> [options]

Required:
  --domain <domain>              Domain pointed to this server (A/AAAA record)
...
BASE_URL="https://${DOMAIN}/packpulse"
